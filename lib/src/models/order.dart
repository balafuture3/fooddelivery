...
class Order {
  ...
  Order.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      delivery_date = jsonMap['delivery_date'] != null ? jsonMap['delivery_date'].toString() : '';
      delivery_time_slot = jsonMap['delivery_time_slot'] != null ? jsonMap['delivery_time_slot'].toString() : '';
      slots = jsonMap['slots'] != null ? jsonMap['slots'].toString() : '';
  ...
  Map toMap() {
    ...
    map['delivery_time_slot'] = delivery_time_slot;
    map['slots'] = slots;

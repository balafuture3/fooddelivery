...
class S {
  ...
  /// `Please select a date and TimeSlot to continue`
  String get Please_select_a_date_to_Continue {
    return Intl.message(
      'Please select a date and TimeSlot to continue',
      name: 'Please_select_a_date_to_Continue',
      desc: '',
      args: [],
    );
  }
  ...
  String get Time_slot_not_available {
    return Intl.message(
      'Time Slot Not Available',
      name: 'Time_slot_not_available',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your order has been successfully submitted! Waiting for approval`
  String get Oder_Pending_for_approval {
    return Intl.message(
      'Your order has been successfully submitted! Waiting for approval',
      name: 'Oder_Pending_for_approval',
      desc: '',
      args: [],
    );
  }

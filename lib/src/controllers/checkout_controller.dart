...
class CheckoutController extends CartController {
  ...
  void addOrder(List<Cart> carts   ) async {
    ...
    _order.delivery_date=DataStorage.selectedDate;
    _order.delivery_time_slot=DataStorage.slotId.toString();
...
print("selected date in checkout controller${ DataStorage.selectedDate}");
print("slot id in checkout controller${DataStorage.slotId}");

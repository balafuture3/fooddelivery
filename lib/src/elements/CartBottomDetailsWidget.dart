...
class CartBottomDetailsWidget extends StatelessWidget {
  const CartBottomDetailsWidget({Key key,@required CartController con ,this.selectedDateFormatted})  : _con = con, super(key: key);
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DataStorage.slotId!=null?Row(
              children: <Widget>[
                Expanded(
                  child: Text(
                    '${S.of(context).Selected_time_slot}',
                    style: Theme.of(context).textTheme.bodyText1,
                  ),
                ),

                Text("${DataStorage.slots}",style: Theme.of(context).textTheme.bodyText1)
              ],
            ):Text(""),
            SizedBox(height: 10),
            Stack(

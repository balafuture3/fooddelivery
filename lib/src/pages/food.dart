                    ...
                    child: Padding(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          _con.food.ingredients == null ?SizedBox(height: 20):ListTile(
                            dense: true,
                            contentPadding: EdgeInsets.symmetric(vertical: 10),
                            leading: Icon(
                              Icons.donut_small,
                          ...
                          _con.food.nutritions.length==0? SizedBox(height: 20) :ListTile(
                            dense: true,
                            contentPadding: EdgeInsets.symmetric(vertical: 10),
                            leading: Icon(
                                ...
                                child: FlatButton(
                                  onPressed: () async {
                                    ...
                                    if (currentUser.value.apiToken == null)  {
                                      ...
                                      // _con.listenForCart();
                                      // print(_con.food.toMap());

                                    }
                                    else {

                                      print("prnt ${(_con.isSameRestaurants(_con.food))}");

                                      if (_con.isSameRestaurants(_con.food)) {
                                        print("add to cart");
                                        _con.addToCart(_con.food);
                                      } else {
                                        /// Attn: Remove the two lines below to block
                                        /// adding food from multiple restaurants
                                        _con.addToCart(_con.food);
                                        return;
                                        showDialog(
                                          context: context,
